    ...
    return (
        <React.Fragment>
            <input
                ...
                onChange={handleChange(DataFields.abundance)}
            />
            ...
            <div className="has-text-centered">
                {coordinatesAttached ? (
                    ...
                    <button className="button is-xanadu-light" onClick={currentLocation}>
            ...
            <input
                className="input"
                type="text"
                placeholder="Temperature as Degrees in Celsius"
                onChange={handleChange(DataFields.temperature)}
            />
